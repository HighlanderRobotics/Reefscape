...
public class WristSubsystem extends SubsystemBase {
  ...
  public static final Rotation2d WRIST_SCORE_L1_POS = Rotation2d.fromDegrees(-60);
  public static final Rotation2d WRIST_WHACK_L1_POS = Rotation2d.fromDegrees(-60);
