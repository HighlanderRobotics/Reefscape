...
public class AlphaSwerveConstants extends SwerveConstants {
  ...
  public Module.ModuleConstants getFrontLeftModule() {
    return new Module.ModuleConstants(
        0, "Front Left", 0, 1, 0, Rotation2d.fromRotations(-0.215088));
  }

  @Override
  public Module.ModuleConstants getFrontRightModule() {
    return new Module.ModuleConstants(
        1, "Front Right", 2, 3, 1, Rotation2d.fromRotations(-0.48974609375));
  }

  @Override
  public Module.ModuleConstants getBackLeftModule() {
    return new Module.ModuleConstants(2, "Back Left", 4, 5, 2, Rotation2d.fromRotations(0.226807));
  }

  @Override
  public Module.ModuleConstants getBackRightModule() {
    return new Module.ModuleConstants(3, "Back Right", 6, 7, 3, Rotation2d.fromRotations(0.206787));
  }
