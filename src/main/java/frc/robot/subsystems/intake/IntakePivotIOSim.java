...
public class IntakePivotIOSim implements IntakePivotIO {
  ...
  // TODO: TUNE
  ProfiledPIDController pivotPid = new ProfiledPIDController(0.0, 0.0, 0.0, new TrapezoidProfile.Constraints(10.0, 10.0));
  // TODO: TUNE
  ...
  public void updateInputs(IntakePivotIOInputs inputs) {
    ...
    inputs.angularVelocityRotsPerSec = RadiansPerSecond.of(intakePivotSim.getVelocityRadPerSec()).in(RotationsPerSecond);
  ...
  public void setMotorPosition(Rotation2d targetPosition) {
    setMotorVoltage(pivotPid.calculate(intakePivotSim.getAngleRads(), targetPosition.getRadians())
