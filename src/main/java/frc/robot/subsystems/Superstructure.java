...
public class Superstructure {
  ...
  private void addManipulatorStates() {
    ...
    new Trigger(() -> state == SuperState.PRE_BARGE)
        .whileTrue(manipulator.holdAlgaeExtra())
        .whileFalse(Commands.none());

    // score algae processor
    new Trigger(() -> state == SuperState.PROCESSOR)
        .whileTrue(manipulator.scoreAlgaeProcessor())
        .whileFalse(Commands.none());
